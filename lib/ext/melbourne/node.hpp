...
#define NEW_FIXNUM(l,yl) NEW_NODE2(NODE_FIXNUM,yl,0,0,l)
#define NEW_NUMBER(l,yl) NEW_NODE2(NODE_NUMBER,yl,l,0,0)
#define NEW_HEXNUM(l,yl) NEW_NODE2(NODE_HEXNUM,yl,l,0,0)
#define NEW_OCTNUM(l,yl) NEW_NODE2(NODE_OCTNUM,yl,l,0,0)
#define NEW_BINNUM(l,yl) NEW_NODE2(NODE_BINNUM,yl,l,0,0)
#define NEW_FLOAT(l,yl) NEW_NODE2(NODE_FLOAT,yl,l,0,0)
